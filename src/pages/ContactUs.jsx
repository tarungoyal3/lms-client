...
//               className="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-400"
//               required
//             />
//           </div>
//           <div className="relative">
...
//               className="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-xl h-36 focus:outline-none focus:ring-2 focus:ring-blue-400 resize-none"
//               required
//             />
//           </div>
//           <motion.button
